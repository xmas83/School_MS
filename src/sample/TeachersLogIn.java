        ...
        if (!this.userName.getText().equals("") && !this.password.getText().equals("")) {
            ...
            for(int i = 0; i < loginIDList.size(); ++i) {
                ...
                if (this.userName.getText().equals(loginIDList.get(i)) && this.password.getText().equals(passwordList.get(i))) {
                    System.out.println("Checking teacher status...");

                    if (DBConnections.isTeacher(ssnList.get(i))) {
                        ...
                        myController.loadScene(SchoolAppFramework.teacherSceneID, SchoolAppFramework.teacherSceneFile);
                        myController.setScenes(SchoolAppFramework.teacherSceneID);
                    } else {
                        messageLabel.setText("You are not a teacher, please log in to \nthe correct page.");
